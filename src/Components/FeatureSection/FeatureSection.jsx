...
const FeatureSection = () => {
  const Icon = (IconComponent) => {
    return (
      <IconComponent size={70} style={{ fill: "#35486F" }}></IconComponent>
    );
  };
  ...
  return (
    <Section id="services" padding="60px 0">
      <Container>
        <Row align="center" wrap="wrap" justify="center" gap="1.4rem">
          <Heading mb="1rem" $inverse>
            Amazing Features
          </Heading>
          <GridContainer $gap="1.4rem" gtc="1fr 1fr 1fr " justify="center">
